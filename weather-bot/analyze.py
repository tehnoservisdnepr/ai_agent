    ...
    try:
        ...
        def save_to_db():
            try:
                ...
                conn.commit()
                print("✅ Данные в БД сохранены. Отправляем в MQTT...")
                ...
                print("📡 Данные успешно улетели на Дачу!")
                
                cursor.close()
                conn.close()
            except Exception as db_e:
                print(f"❌ Ошибка БД/MQTT: {db_e}")

        # ВЫЗЫВАЕМ функцию сохранения асинхронно
