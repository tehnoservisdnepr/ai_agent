...
# Используем актуальную модель Llama 3.1
        response = await client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "Ты эксперт-инженер. Оценивай новости по шкале от 1 до 10. "
                    "Твои приоритеты: Linux, микроконтроллеры, электроника, солнечная энергетика и автоматизация. "
                    "Если новость касается этих тем, ставь оценку выше 7. "
                    "Дай краткий вердикт на русском языке. НЕ используй символы * и _."
                },
